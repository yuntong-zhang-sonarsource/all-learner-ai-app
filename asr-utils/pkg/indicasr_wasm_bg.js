 ...
 * @returns {Array<any>}
 */
export function run_preprocessor(audio_file) {
    const ptr0 = passArray8ToWasm0(audio_file, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_preprocessor(ptr0, len0);
 ...
 * @returns {Array<any>}
 */
export function decode_logprobs(logprobs, shape, vocab_arr, offset, actual_vocab_size) {
    const ptr0 = passArray32ToWasm0(shape, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_logprobs(addHeapObject(logprobs), ptr0, len0, addHeapObject(vocab_arr), offset, actual_vocab_size);
    return takeObject(ret);
}
 ...
 * @returns {Array<any>}
 */
export function decode_logprobs_topk(logits, shape, vocab_arr, offset, actual_vocab_size, topk) {
    const ptr0 = passArray32ToWasm0(shape, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_logprobs_topk(addHeapObject(logits), ptr0, len0, addHeapObject(vocab_arr), offset, actual_vocab_size, topk);
    return takeObject(ret);
}
...
export function __wbg_new_1da7377de0530afc(arg0) {
