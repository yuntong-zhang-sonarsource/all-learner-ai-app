...
import { WordRedCircle } from "../../utils/constants";
              ...
              >
                ...
                {wIndex == 0 && (
                  <Box sx={{ position: "absolute" }}>
                    <WordRedCircle height={elem?.length < 3 ? 150 : 200} />
                  </Box>
                )}
                {wIndex == 0 && (
                  <Box
                ...
                {wIndex == 0 && (
                  <Box
                    sx={{
                      position: "absolute",
                      left: words?.length > 1 ? "-180px" : undefined,
                      right: words?.length == 1 ? "-180px" : undefined,
                    }}
                  >
                ...
                {elem?.split("")?.map((char, index) => (
                  <span
                    style={{
                      ...
                      letterSpacing: "2%",
                      fontFamily: "Quicksand",
                      marginLeft: index > 0 ? "50px" : undefined,
                    }}
                  >
                    {char}
                  </span>
